...
# sandbox_manager module not found - ContainerProvisioner
# sandbox_manager not found - Any
# sandbox_manager not found - MTLSEnforcer
# sandbox_manager not found - exceptions
...
_container_provisioner: Optional[Any] = None

_command_executor: Optional[Any] = None

_mtls_enforcer: Optional[Any] = None


def get_container_provisioner() -> Any:
    """Get the container provisioner instance."""
...
def get_command_executor() -> Any:
    """Get the global Any instance."""
...
def get_mtls_enforcer() -> Any:
    """Get the mtls enforcer instance."""
