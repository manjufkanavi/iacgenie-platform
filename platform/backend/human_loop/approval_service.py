...
class ApprovalService:
    ...
    async def request_approval(self, session_id: str, approval_type: str, context: dict = None):
    ...
    async def submit_approval(self, approval_token: str, approved: bool, comments: str = None):
