...
const SESSION_SECRET = process.env.SESSION_SECRET || 'dashboard-session-secret';
const DASHBOARD_URL_BASE = process.env.DASHBOARD_URL_BASE || 'https://dashboard.iacgenie.com';
...
app.get('/dashboard', verifyToken, function(req, res) {
  ...
  var html = '<!DOCTYPE html><html><head><title>' + TITLE + '</title>' +
    ...
    '<div class="user-info"><span>Q' + (u.preferred_username || 'User') + '</span>' +
